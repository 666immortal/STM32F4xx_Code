...
* 函数功能: TIM2中断服务函数，每隔1ms进入一次中断服务函数，s_i2msFlag每隔2ms由中断服务函数置为TRUE，在App.c中，
*          由Proc2msTask中的Clr2msFlag函数将s_i2msFlag置为FALSE。 
* 输入参数: void
* 输出参数: void
* 返 回 值: void
* 创建日期: 2018年01月01日
...
* 函数功能: TIM5中断服务函数，每隔1ms进入一次中断服务函数，s_i1secFlag隔1秒由中断服务函数置为TRUE，在App.c中，
*          由Proc1SecTask中的Get1SecFlag函数将s_i1secFlag置为FALSE。 
* 输入参数: void
* 输出参数: void
* 返 回 值: void
* 创建日期: 2018年01月01日
...
void InitTimer(void)
{
  ...
  ConfigTimer5(999, 89);  //90Mhz/(89+1)=1MHz（对应1us），由0计数到999为1000*1us=1ms
}
